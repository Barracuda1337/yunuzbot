...
client.ayarlar = {
  oynuyor: "!!yardım",
  official_sahip: "319915856903667712",
  sahip: "319915856903667712",

  yardimcilar: [""],
  isim: "Yunuz",
  botD:
    "https://discordapp.com/oauth2/authorize?client_id=697892179317751921&scope=bot&permissions=8",
  webS: "https://yunuzbot.glitch.me/",
  web: "https://yunuzbot.glitch.me/",
  site: "hhttps://yunuzbot.glitch.me/",
  dblO: "https://discordbots.org/bot/697892179317751921/vote",
  dbl: "https://discordbots.org/bot/697892179317751921",
  dbltoken:
        "",
  webpanel: "https://yunuzbot.glitch.me/",
  versiyon: "2.0",
  prefix: "!!",
  renk: "RANDOM",
  version: "1.0.0"
...
client.avatarURL = `https://cdn.discordapp.com/app-icons/697892179317751921/e6c82aed8ee7fc43ff884556e4cb4aa4.png?size=2048`;
...
client.on("guildCreate", guild => {
  const e = new Discord.RichEmbed()
    .setColor("RANDOM")
    .setDescription(
      "Hey, ben Yunuz. Az önce beni ekledin.\n!!yardım yazarak bilgi alabilirsin."
    )
...
let i = db.fetch(`üyelikk_${msg.author.id}`)
  ...
  .setAuthor(`Yunuz`,`${msg.author.avatarURL || msg.author.displayAvatarURL}`)
...
client.login("Njk3ODkyMTc5MzE3NzUxOTIx.Xo95bA.9nN4TQBKlRD_Yvnq_X6eweAeE_8");