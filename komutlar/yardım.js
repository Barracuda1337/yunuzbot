...
const footer = `[${dil.special.botinvite}](https://discordapp.com/oauth2/authorize?client_id=${client.user.id}&scope=bot&permissions=8) | [${dil.special.supportserver}](https://discordapp.com/invite/ZRgy4mD) | [${dil.special.DBLpage}](${client.ayarlar.webpanel})`;
